export const messages = {
  'zh-CN': {
    ...
    history: {
      ...
      deletingAction: '删除中...',
      deleteConfirm:
        '确认彻底删除这 {count} 条训练记录吗？相关复盘、审计日志、长期记忆、复习计划和检索索引也会一起清掉，且不能恢复。',
      deleteSuccess: '已删除 {count} 条训练记录。',
      prev: '上一页',
      next: '下一页',
    },
    session: {
  ...
  en: {
    ...
    history: {
      ...
      deleteErrorTitle: 'Delete session failed',
      filters: {
        allModes: 'All modes',
      ...
      batch: {
        kicker: 'Batch actions',
        description:
          'Select sessions across pages, then either export them together as a {format} archive or permanently delete them.',
        ...
        deleteAction: 'Delete selected ({count})',
        deletingAction: 'Deleting selection...',
      ...
      deleteConfirm:
        'Permanently delete these {count} sessions? Their reviews, audit logs, long-term memory, review plans, and retrieval indexes will be removed too.',
      deleteSuccess: '{count} sessions deleted.',
      prev: 'Previous',
      next: 'Next',
    },
    session: {
